                  ...
                  <div class="email-app-sidebar">
                    ...
                    <ul class="nav main-menu" role="tablist">
                      <li @click="setactiveemails(0)" class="nav-item">
                        <a
                          class="btn-primary btn-block btn-mail"
                          ...
                          aria-selected="true"
                          ><i class="icofont icofont-envelope mr-2"></i> NEW
                          MAIL</a
                        >
                      </li>
                      <li @click="type = 'inbox'" class="nav-item">
                        <a
                          class="show"
                          ...
                          aria-selected="false"
                          ><span class="title"
                            ><i class="icon-import"></i> Inbox</span
                          ><span class="badge pull-right digits"
                            >({{ index }})</span
                          ></a
                        >
                      </li>
                      <li @click="type = 'all mail'">
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-folder"></i> All mail</span
                          ></a
                        >
                      </li>
                      <li @click="type = 'sent'">
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-new-window"></i> Sent</span
                          ><span class="badge pull-right digits"
                            >({{ send }})</span
                          ></a
                        >
                      ...
                      <li @click="type = 'draft'">
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-pencil-alt"></i> DRAFT</span
                          ><span class="badge pull-right digits"
                            >({{ draft }})</span
                          ></a
                        >
                      ...
                      <li @click="type = 'trash'">
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-trash"></i> TRASH</span
                          ><span class="badge pull-right digits"
                            >({{ trash }})</span
                          ></a
                        >
                      ...
                      <li>
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-info-alt"></i> IMPORTANT</span
                          ></a
                        >
                      </li>
                      <li @click="type = 'starred'">
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-star"></i> Starred</span
                          ><span class="badge pull-right digits"
                            >({{ starred }})</span
                          ></a
                        >
                      ...
                      <li>
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-email"></i> UNREAD</span
                          ></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-export"></i> SPAM</span
                          ></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-share"></i> OUTBOX</span
                          ></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-file"></i> UPDATE</span
                          ></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-bell"></i> ALERT</span
                          ></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          ><span class="title"
                            ><i class="icon-notepad"></i> NOTES</span
                          ><span class="badge pull-right digits">(20)</span></a
                        >
                      </li>
                    </ul>
                  </div>
              ...
              <div class="card email-body">
                <div class="pr-0 b-r-light">
                  ...
                  <div class="inbox custom-scrollbar">
                    <div
                      class="media active"
                      v-for="(list, index) in emaillist"
                      :key="index"
                      @click="setactiveemails(list.id)"
                    >
                      <div class="media-size-email">
                        <img
                      ...
                      <div class="media-body">
                        <h6>
                          {{ list.name
                            ...
                            ><span class="digits"
                              >({{ new Date(list.date) | moment("D") }}</span
                            >
                            {{ new Date(list.date) | moment("MMMM")
                            }}<span class="digits">
                              {{ new Date(list.date) | moment("YYYY") }})</span
                            ></small
                          >
                        </h6>
                        <p>{{ list.subject }}</p>
                      ...
                      <div class="email-content">
                              ...
                              <div class="float-right d-flex">
                                ...
                                <span
                                  ><samp
                                    ...
                                    :class="{
                                      'text-warning': activeemail.favourite,
                                    }"
                                    ><i
                        ...
                        <div class="email-wrapper">
                          ...
                          <div class="d-inline-block">
                            ...
                            <a
                              class="text-muted text-right right-download"
                              href="#"
                              ><i class="fa fa-long-arrow-down mr-2"></i
                              >Download All</a
                            >
                            ...
                            <ul class="actions">
                              <li>
                                <a class="text-muted" href="#"
                                  ><i class="fa fa-reply mr-2"></i>Reply</a
                                >
                              </li>
                              <li>
                                <a class="text-muted" href="#"
                                  ><i class="fa fa-reply-all mr-2"></i>Reply
                                  All</a
                                >
                              </li>
                              <li>
                                <a class="text-muted" href="#"
                                  ><i class="fa fa-share mr-2"></i></a
                                >Forward
                              </li>
                            </ul>
                          </div>
